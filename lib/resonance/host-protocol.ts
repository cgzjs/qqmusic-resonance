...
export type AccountAction = "favorite" | "unfavorite" | "listen" | "later" | "removeLater" | "event";
export type AccountData = { favoriteIds: string[]; listenLaterIds: string[]; events: import("./types").JourneyEvent[]; history: { id: string; trackId: string; listenedAt: number }[]; onlineExchanges: import("./exchange-protocol").OnlineExchangeRecord[] };
export const emptyAccountData: AccountData = { favoriteIds: [], listenLaterIds: [], events: [], history: [], onlineExchanges: [] };
